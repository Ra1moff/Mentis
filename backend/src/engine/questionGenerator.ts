  ...
  if (difficulty === 'Easy') {
    ...
    switch (type) {
      ...
      case 4: {
        ...
        // target * pct / 100 = integer -> target * pct must be multiple of 100
        // e.g. target must be multiple of 100 / gcd(100, pct)
        let base = 10;
    ...
    switch (type) {
      ...
      case 2: {
        ...
        const a = getRandomInt(1, b - 1); // standard proper fraction
        // c must be multiple of b
      ...
      case 3: {
        ...
        const pct = percents[getRandomInt(0, percents.length - 1)];
        // let's ensure num * pct / 100 is an integer
        // num should be multiple of 100 / gcd(pct, 100)
      ...
      case 4: {
        // Complex arithmetic: e.g. a^3 - b * c or (a * b) - c^2
        if (Math.random() > 0.5) {
          const a = getRandomInt(2, 6); // a^3
